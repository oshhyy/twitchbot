...
module.exports = {
    ...
    execute: async context => {
        try {
            ...
            const data = await got(`https://ws.audioscrobbler.com/2.0/?method=user.getinfo&user=${lastfmName}&api_key=${config.lastfmKey}&format=json`, throwHttpsErrors = true).json()
            if(data.message) {
